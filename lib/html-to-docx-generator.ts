...
async function generatePerfectWordDocument(resumeData: ResumeData): Promise<void> {
  ...
  // Contact Information with Icons (10pt, centered, with proper spacing)
  const contactInfo: TextRun[] = []

  if (resumeData.personalInfo.phone) {
    if (contactInfo.length > 0) contactInfo.push(new TextRun({ text: "    ", font: "Arial", size: 20 })) // 4 spaces
    contactInfo.push(
      new TextRun({ text: "📞 ", font: "Arial", size: 20 }),
      new TextRun({ text: resumeData.personalInfo.phone, font: "Arial", size: 20 }),
    )
  }

  if (resumeData.personalInfo.email) {
    if (contactInfo.length > 0) contactInfo.push(new TextRun({ text: "    ", font: "Arial", size: 20 }))
    contactInfo.push(
      new TextRun({ text: "✉️ ", font: "Arial", size: 20 }),
      new TextRun({ text: resumeData.personalInfo.email, font: "Arial", size: 20 }),
    )
  }
  ...
  if (resumeData.personalInfo.linkedin) {
    ...
    contactInfo.push(
      new TextRun({ text: "💼 ", font: "Arial", size: 20 }),
      new TextRun({ text: resumeData.personalInfo.linkedin, font: "Arial", size: 20 }),
    )
  }
  ...
  if (resumeData.personalInfo.github) {
    ...
    contactInfo.push(
      new TextRun({ text: "🔗 ", font: "Arial", size: 20 }),
      new TextRun({ text: resumeData.personalInfo.github, font: "Arial", size: 20 }),
    )
  }
  ...
  if (resumeData.personalInfo.leetcode) {
    ...
    contactInfo.push(
      new TextRun({ text: "💻 ", font: "Arial", size: 20 }),
      new TextRun({ text: "leetcode", font: "Arial", size: 20 }),
    )
  }
